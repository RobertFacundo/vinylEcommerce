    ...
    return (
        <div className="flex flex-col md:flex-row w-full">
            ...
            <div className="md:w-1/2 flex flex-col py-4 px-8">
                <p className="text-[#C89268] text-sm font-semibold mb-5">OUR PHILOSOPHY</p>
                <h1 className=" text-6xl md:text-7xl mb-6 leading-[1.05] font-[family-name:var(--font-alegreya)] font-semibold mb-7">Music deserves to be felt.</h1>
                <div className="flex flex-col gap-2 mb-8 text-base md:text-lg opacity-80 font-[family-name:var(--font-geist-mono)] tracking-tighter">
                    <p>
